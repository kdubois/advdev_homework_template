...
oc set volume dc/jenkins --add --overwrite --name=jenkins-data --mount-path=/var/lib/jenkins --type persistentVolumeClaim --claim-name=${GUID}-jenkins-pvc --claim-size=4Gi
